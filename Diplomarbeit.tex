...
\begin{document}
	...
	\input{title}									%Externe .tex Datei für Titel einbinden
	...
	\addcontentsline{toc}{chapter}{Eidesstattliche Erklärung}	%Erklärung händisch ins Inhaltsverzeichnis einfügen
	\input{erklaerung}												%Externe .tex Datei für Erklärung einfügen
	\clearpage																%Neue Seite beginnen
  ...
  \input{diagrams}
	\clearpage
\glossary{ name=Individualsoftware, description={Individualsoftware zeichnet sich dadurch aus, dass sie nur für einen oder für wenige Anwendungsfälle geschaffen wird.}}
\clearpage
